...
*/
/*Declare variables to generate random quotes for a quote */
var randomQ = randomInt(0, 9)
var quoteElm = document.getElementsByTagName("quote")[0];

/* Display Quote */
quoteElm.innerHTML = getQuote(randomQ);

/* Random Integer function */
function randomInt(lowest, size) {
    return lowest + Math.floor(Math.random()*size)
}

/* Function that holds Jane's quotes */
function getQuote(n) {
   var quotes = [
